...
public class ShoppingCarAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (isSelect) {
            ...
            childViewHolder.view.setBackgroundColor(context.getResources().getColor(R.color.xui_config_color_background_phone));
        } else {
            childViewHolder.ivSelect.setImageResource(R.mipmap.unselect);
            childViewHolder.view.setBackgroundColor(context.getResources().getColor(R.color.xui_config_color_50_white));
        }
