...
public class MessageRecyclerlistAdapter extends RecyclerView.Adapter<MessageRecyclerlistAdapter.MyViewHolder> {
    ...
    public MessageRecyclerlistAdapter(Context context, List<MessageListBean> mList) {
    ...
    public void setOnRecyclerViewListener(MessageRecyclerlistAdapter.onRecyclerViewListener onRecyclerViewListener) {
